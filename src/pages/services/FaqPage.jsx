    ...
    general: [
      {
        ...
        answer: 'Наши аниматоры работают с детьми от 3 лет и старше. Для детей 4-6 лет - активные игры и развлечения, а для школьников готовим квесты и тематические приключения.'
      },
      {
