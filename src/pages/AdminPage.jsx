...
const [editingService, setEditingService] = useState(null);
  ...
  const handleServiceSubmit = (e) => {
    e.preventDefault();
    console.log('Новая услуга:', serviceForm);
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600">Активные</p>
              <p className="text-2xl font-bold text-gray-900">{adminservices.filter(s => s.status === 'active').length}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{services.filter(s => s.featured).length}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <button onClick={() => { setShowAddService(false); resetServiceForm(); }} className="text-gray-400 hover:text-gray-600">
                <X className="h-6 w-6" />
              </button>
            </div>
            ...
            <form onSubmit={handleServiceSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="anniversaries">Юбилеи</option>
                    <option value="seasonal">Праздники</option>
                    ...
                    <option value="animators">Аниматоры</option>
                  </select>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  placeholder="Дни рождения, Выпускные, Школьные мероприятия"
                />
              </div>
  
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">URLs изображений (через запятую)</label>
                <textarea
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  placeholder="дети, праздник, веселье, аниматоры"
                />
              </div>
